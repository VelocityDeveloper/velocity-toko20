...
function velocitychild_theme_setup()
{
    ...
    if (class_exists('Kirki')) :
        ...
        Kirki::add_panel('panel_toko20', [
            'priority'    => 10,
            'title'       => esc_html__('Toko 20', 'justg'),
...
// add_action('justg_header', 'justg_header_toko20');
// function justg_header_toko20()
// {

// }
// add_action('justg_do_footer', 'justg_footer_toko20');
// function justg_footer_toko20()
// {
...
{
    require_once(get_stylesheet_directory() . '/inc/part-headertop.php');
    echo '<div class="card rounded-0 border-0 container p-3 bg-light mx-auto">';
...
add_action('velocitytoko_product_loop', 'velocitytoko20_content_product', 30);
function velocitytoko20_content_product($post)
{
    if (is_singular('product')) :
        $class = 'col-xl-3 col-md-3 col-6 mb-2 px-2';
    else :
        $class = 'col-xl-3 col-md-3 col-6 mb-2 px-2';
    endif;
    ?>
    <article <?php post_class($class); ?> id="post-<?php the_ID(); ?>">
        <div class="card h-100 rounded-1 card-product p-2 overflow-hidden">
